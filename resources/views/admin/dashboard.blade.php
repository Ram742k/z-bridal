...
<script>
    ...
    // Now you can use invoiceData in your JavaScript code
    console.log(invoiceData.sales);
    console.log(invoiceData.online);
    console.log(invoiceData.cash);
...
<div class="row gx-3">
								...
								<div class="card mb-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<h3 class="m-0 text-primary">{{$sales}}</h3>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-sm-6 col-12">
								<div class="card mb-3">
									<div class="card-body">
										<div class="mb-2">
											<i class="bi bi-person-square fs-1 text-primary lh-1"></i>
										</div>
										<div class="d-flex align-items-center justify-content-between">
											<h5 class="m-0 text-secondary fw-normal">Employees</h5>
											<h3 class="m-0 text-primary">{{$totalEmployees}}</h3>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-sm-6 col-12">
								<div class="card mb-3">
									<div class="card-body">
										<div class="arrow-label">{{$percentageChange}}%</div>
										<div class="mb-2">
											<i class="bi bi-box-seam fs-1 text-primary lh-1"></i>
										</div>
										<div class="d-flex align-items-center justify-content-between">
											<h5 class="m-0 text-secondary fw-normal">Expenses</h5>
											<h3 class="m-0 text-primary">{{$totalExpense}}</h3>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-3 col-sm-6 col-12">
								<div class="card mb-3">
									<div class="card-body">
										...
										<div class="d-flex align-items-center justify-content-between">
											<h5 class="m-0 text-secondary fw-normal">Customers</h5>
											<h3 class="m-0 text-primary">{{$totalCustomers}}</h3>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="row gx-3">
											...
											<div class="col-lg-2 col-sm-12 col-12">
												<div class="border px-2 py-4 rounded-5 h-100 text-center">
													...
													<div class="mb-4">
														<h2 class="text-danger">${{$monthlyAverage}}</h2>
